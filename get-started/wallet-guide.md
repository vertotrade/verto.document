...
To get started on VertoTrade, the first thing you'll need is to set up a wallet that supports Rebuschain (REBUS). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with VertoTrade.

| Feature                                                           | MetaMask  | Coinbase Wallet  |
| ----------------------------------------------------------------- | --------- | ---------------- |
| Rebuschain support                                                | ⚠️         | ✅               |
| Built-in DApp browser                                             | ➖        | ✅               |
| Hardware wallet compatible                                        | ✅        | ✅               |
| Open source (auditability)                                        | ✅        | ✅               |

<!--
| Feature                                                           | MetaMask  | Coinbase Wallet  |  Token Pocket |
| ----------------------------------------------------------------- | --------- | ---------------- | ------------- |
| Rebuschain support                                                | ⚠️         | ✅               | ✅            |
| Built-in DApp browser                                             | ➖        | ✅               | ✅            |
| Hardware wallet compatible                                        | ✅        | ✅               | ➖            |
...
MetaMask is a very popular browser-based wallet plugin that supports ERC20 (Ethereum network) which is also supported by Rebuschain.

​**Pros:**

* Open source for auditability
* WEB3 capable on Rebuschain
...
* Additional steps needed to use with Rebuschain and VertoTrade
* Extra information and settings may confuse beginners

[**Download MetaMask**](https://metamask.io/download.html) (Automatically detects device)\
[**MetaMask Setup Guide**](https://docs.rebuschain.com/knowledge/wallets/metamask-browser-extension/)
{% endtab %}

{% tab title="Coinbase Wallet" %}
![Coinbase Wallet](/public/assets/coinbase-wallet.png)

Millions of users choose Coinbase Wallet to earn yield with DeFi, swap more than 5,500 assets, and hold their NFT collections. Coinbase wallet supports BEP2 & BEP20 (Binance Chain and Rebuschain networks).

**Highlights:**

* Most downloaded mobile dapp wallet in the United States with 12M+ active Wallet users.
* No additional steps needed to use with Rebuschain and VertoTrade.
...
// TODO REWRITE INSTRUCTIONS BELOW
...
1. On the next page, find **Rebuschain** in the list and tap it.
...
To connect to Rebuschain and use VertoTrade, you can follow the TokenPocket section of our Connect Your Wallet to VertoTrade guide [https://docs.vertotrade.com/get-started/connection-guide](https://docs.vertotrade.com/get-started/connection-guide).
...
1. On the next page, tap the **Rebuschain** entry. Be careful not to tap the address part, or you’ll only copy that to clipboard instead.
...
The genuine VertoTrade site and staff will never ask you to input your seed phrase.\*\*
{% endhint %}
...
This comparison table gives an overview of the most popular desktop wallets used with VertoTrade.

|                                                                   | MetaMask  | Coinbase Wallet  | Token Pocket  |
| ----------------------------------------------------------------- | --------- | ---------------- | ------------  |
| Rebuschain support                                                | ⚠️         | ⚠️                | ⚠️             |
| Built-in DApp browser                                             | ➖        | ➖               | ✅            |
| Hardware wallet compatible                                        | ✅        | ✅               | ➖            |
| Open source (auditability)                                        | ✅        | ✅               | ✅            |
...
MetaMask is a very popular browser-based wallet plugin that supports ERC20 (Ethereum network) by default, and BEP2 & BEP20 (Binance Chain and Rebuschain networks) with a little work.
...
Millions of users choose Coinbase Wallet to earn yield with DeFi, swap more than 5,500 assets, and hold their NFT collections. Coinbase wallet supports ERC20 (Ethereum network) and BEP2 & BEP20 (Binance Chain and Rebuschain networks).
...
* Currently on Chrome (Brave) Only

[**Download Coinbase Wallet**](https://chrome.google.com/webstore/detail/coinbase-wallet-extension/hnfanknocfeofbddgcijnmhnfnkdnaad?hl=en\&authuser=0)[ ](https://chrome.google.com/webstore/detail/coinbase-wallet-extension/hnfanknocfeofbddgcijnmhnfnkdnaad?hl=en\&authuser=0)
...
And that’s it, all done! You can follow our [Connect Your Wallet to VertoTrade guide](https://docs.vertotrade.com/get-started/connection-guide) to connect to Rebuschain and VertoTrade.
{% endtab %}
-->
{% endtabs %}
